...
if (hasWorkerSupport) {
  describe("Worker Pool", () => {
    ...
    it("Simple API Integration", async () => {
    ...
    it("Full API Batch Operations", async () => {
  ...
  describe("Worker Pool", () => {
    it("Skipped (no Worker support)", () => {
      console.log(
        "Worker tests skipped - no Worker support in this environment",
      );
