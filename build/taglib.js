  ...
  return (
    async function (moduleArg = {}) {
      ...
      if (ENVIRONMENT_IS_NODE) {
        const { createRequire } = await (typeof Deno !== "undefined"
          ? import("node:module")
          : import("module"));
      ...
      function findWasmBinary() {
        if (Module["locateFile"]) return locateFile("taglib.wasm");
        return new URL("taglib.wasm", import.meta.url).href;
      }
      ...
      var __embind_register_class_function = (
        ...
        whenDependentTypesAreResolved([], [rawClassType], (classType) => {
          ...
          whenDependentTypesAreResolved([], rawArgTypes, (argTypes) => {
            ...
            } else {proto[methodName].overloadTable[argCount - 2] =
                memberFunction;}
            return [];
          });
          return [];
      ...
      var getStringOrSymbol = (address) => {
        ...
        if (symbol === undefined) return AsciiToString(address);
        return symbol;
      };
      ...
      function assignWasmExports(wasmExports) {
        ...
        _setThrew = wasmExports["ea"];
        __emscripten_tempret_set = wasmExports["fa"];
        __emscripten_stack_restore = wasmExports["ga"];
        __emscripten_stack_alloc = wasmExports["ha"];
        _emscripten_stack_get_current = wasmExports["ia"];
        ___cxa_decrement_exception_refcount = wasmExports["ja"];
        ___cxa_increment_exception_refcount = wasmExports["ka"];
        ___cxa_can_catch = wasmExports["la"];
        ___cxa_get_exception_ptr = wasmExports["ma"];
      }
      var wasmImports = {
