  ...
  return (
    async function (moduleArg = {}) {
      ...
      function findWasmBinary() {
        if (Module["locateFile"]) return locateFile("taglib-wrapper.wasm");
        return new URL("taglib-wrapper.wasm", import.meta.url).href;
      }
      ...
      function assignWasmExports(wasmExports) {
        ...
        ___cxa_decrement_exception_refcount = wasmExports["ma"];
        ___cxa_increment_exception_refcount = wasmExports["na"];
        ___cxa_can_catch = wasmExports["oa"];
        ___cxa_get_exception_ptr = wasmExports["pa"];
      }
      var wasmImports = {
        ...
        w: __emval_incref,
        Z: __emval_instanceof,
        D: __emval_new_array,
        r: __emval_new_cstring,
        G: __emval_new_object,
        aa: __emval_run_destructors,
