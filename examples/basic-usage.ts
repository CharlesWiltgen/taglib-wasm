...
async function demonstrateBasicUsage() {
  ...
  try {
    ...
    const audioFilePath = "./test-files/mp3/kiss-snippet.mp3";
...
async function demonstrateBatchProcessing() {
  ...
  try {
    ...
    const testFiles = [
      "./test-files/wav/kiss-snippet.wav",
      "./test-files/mp3/kiss-snippet.mp3", 
      "./test-files/flac/kiss-snippet.flac",
      "./test-files/ogg/kiss-snippet.ogg",
      "./test-files/mp4/kiss-snippet.m4a",
    ];
